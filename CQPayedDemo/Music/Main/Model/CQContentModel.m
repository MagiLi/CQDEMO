...
+ (NSDictionary *)objectClassInArray {
    return @{@"list" : [CQCategoryCotents_L_List class]};
}
@end
...
@implementation CQCategoryCotents_L_List
+ (NSDictionary *)objectClassInArray{
    return @{@"firstKResults" : [CQC_L_L_Firstkresults class]};
}
@end

@implementation CQC_L_L_Firstkresults
@end
