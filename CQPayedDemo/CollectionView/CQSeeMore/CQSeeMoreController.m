...
@interface CQSeeMoreController ()

@end

@implementation CQSeeMoreController

- (void)viewDidLoad {
    [super viewDidLoad];
    
    [self.tableView registerClass:[LPHomeTodayHotCell class] forCellReuseIdentifier:LPHomeTodayHotCellID];
